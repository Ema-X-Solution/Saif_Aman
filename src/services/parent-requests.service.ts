import { usersAdminService, type UserWritePayload } from "@/services/users-admin.service";
...
export const parentRequestsService = {
  async list(opts?: { page?: number; per_page?: number; search?: string }): Promise<ParentRequest[]> {
